...
<asp:Content ID="Content2" ContentPlaceHolderID="frmBody" runat="server">
    <div class="container">
        ...
        <div class="card">
        <div class="card-body">
            <asp:Label ID="txtClaveEditorial" runat="server" Text="Clave de la Editorial: "></asp:Label>
            <asp:Label ID="txtNombreEdit" runat="server" Text="Nombre de la Editorial: "></asp:Label>
